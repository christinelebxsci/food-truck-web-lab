...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/", (req, res) -> {
            ...
            html += "<option value='salad_egg'>Egg Salad ($8.25)</option>";
            html += "<option value='salad_chicken'>Chicken Salad ($8.75)</option>";
            html += "</select></p>";
            ...
            html += "<option value='sandwich_ham'>Ham Sandwich ($10.25)</option>";
            html += "<option value='sandwich_bacon'>Bacon Sandwich ($7.75)</option>";
            html += "</select></p>";
            ...
            html += "<option value='drink_soda'>Soda ($3.00)</option>";
            html += "<option value='drink_milkshake'>Milkshake ($2.25)</option>";
            html += "</select></p>";
