...
public class Menu {
    ...
    public Menu() {
        ...
        items.put("salad_egg", new Salad("Egg Salad", 8.25));
        items.put("salad_chicken", new Salad("Chicken Salad", 8.75));
        ...
        items.put("sandwich_ham", new Sandwich("Ham Sandwich", 10.25));
        items.put("sandwich_bacon", new Sandwich("Bacon Sandwich", 7.75));
        ...
        items.put("drink_soda", new Drink("Soda", 3.00));
        items.put("drink_milkshake", new Drink("Milkshake", 2.25));
    }
